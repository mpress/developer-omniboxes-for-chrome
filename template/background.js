...
(function(){
    ...
    chrome.omnibox.onInputEntered.addListener(function(text) {
        ...
        if (!text) {
            nav("http://www.example.com/");  // TODO: switch to default URL
            return;
        }
        ...
        // TODO: Implement special suffix handling here
        ...
        if (stripped_text.endsWith(google_codesearch_suffix)) {
            ...
            nav("http://code.google.com/codesearch#search/&q=" + encodeURIComponent(newquery)); // TODO: Throw in extra parameters as appropriate
            return;
        }
        ...
        // TODO: Implement default handling here
        
        nav("http://www.google.com/search?q=" + encodeURIComponent(stripped_text));
    });
})();